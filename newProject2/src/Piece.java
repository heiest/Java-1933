public class Piece {
    ...
    public Piece promotePiece(String c) {
        if (c.equals("q")) {
            if (this.isBlack) {
                Piece qu = new Piece('\u265b', this.row, this.col, this.isBlack);
                return qu;
            } else {
                Piece qu = new Piece('\u2655', this.row, this.col, this.isBlack);
                return qu;
            ...
            if (this.isBlack) {
                Piece roo = new Piece('\u265c', this.row, this.col, this.isBlack);
                return roo;
            } else {
                Piece roo = new Piece('\u2656', this.row, this.col, this.isBlack);
                return roo;
            ...
            if (this.isBlack) {
                Piece bi = new Piece('\u265d', this.row, this.col, this.isBlack);
                return bi;
            } else {
                Piece bi = new Piece('\u2657', this.row, this.col, this.isBlack);
                return bi;
            ...
            if (this.isBlack) {
                Piece kni = new Piece('\u265e', this.row, this.col, this.isBlack);
                return kni;
            } else {
                Piece kni = new Piece('\u2658', this.row, this.col, this.isBlack);
                return kni;
